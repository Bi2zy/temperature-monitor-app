"""
Sistema de Monitoreo de Temperatura - Compatible con NEXT_PUBLIC_
"""
...
def initialize_supabase_client():
    ...
    try:
        ...
        st.success(f"✅ ¡Conectado a Supabase! ({len(test_result)} registros encontrados)")
        return supabase
...
def simulate_temperature_data(supabase, num_readings=5):
    ...
    try:
        locations = ["Sala Principal", "Cocina", "Dormitorio", "Exterior", "Oficina"]
    ...
    if supabase:
        ...
        try:
            ...
            if readings:
                ...
                with col2:
                    st.metric("🌡️ Temp. Promedio", f"{df['temperature_c'].mean():.1f}°C")
                with col3:
                ...
                st.warning("📭 No hay datos en la base de datos. Usa el simulador para agregar datos.")
