...
days = st.sidebar.selectbox("Periodo (días)", [1, 7, 30, 90], index=1, help="Filtrar lecturas de los últimos N días")
...
if supabase_url and supabase_key:
	...
	sample = [
		{"sensor_id": "sensor_001", "location": "Sala Principal", "temperature_c": 22.5, "humidity": 45, "timestamp": "2025-10-28T12:00:00Z"},
		{"sensor_id": "sensor_002", "location": "Cocina", "temperature_c": 24.3, "humidity": 55, "timestamp": "2025-10-27T18:30:00Z"},
	]
...
try:
	...
	st.download_button("📥 Descargar CSV", data=csv_bytes, file_name=f"temperature_history_{days}d.csv", mime="text/csv")
